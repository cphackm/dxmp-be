...
--
-- Host: localhost    Database: dxmp2016
-- ------------------------------------------------------
...
CREATE TABLE `playlist_songs` (
  ...
  KEY `FK_playlist_songs_playlist_id` (`playlist_id`),
  KEY `FK_playlist_songs_song_id` (`song_id`),
...
CREATE TABLE `songs` (
  ...
  KEY `FK_songs_added_by` (`added_by`),
  KEY `FK_songs_artist_id` (`artist_id`),
  CONSTRAINT `FK_songs_added_by` FOREIGN KEY (`added_by`) REFERENCES `users` (`id`),
...
CREATE TABLE `tags` (
  ...
  KEY `FK_tags_song_id` (`song_id`),
  CONSTRAINT `FK_tags_song_id` FOREIGN KEY (`song_id`) REFERENCES `songs` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tracking` (
  ...
  KEY `FK_tracking_song_id` (`song_id`),
  CONSTRAINT `FK_tracking_song_id` FOREIGN KEY (`song_id`) REFERENCES `songs` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-10-02 20:41:39
